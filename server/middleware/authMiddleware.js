...
// Generates a reset token. Since no email service is configured, the
// reset link is returned directly in the response for the demo/FYP build --
// in a real production app this would be emailed to the user instead.
